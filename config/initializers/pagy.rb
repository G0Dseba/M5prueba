...
# You can set any pagy variable as a Pagy::VARS. They can also be overridden per instance by just passing them to
# Pagy.new|Pagy::Countless.new|Pagy::Calendar::*.new or any of the #pagy* controller methods
# Here are the few that make more sense as DEFAULTs:
Pagy::VARS[:items] = 10                    # default
# Pagy::VARS[:size]        = [1,4,4,1]       # default
# Pagy::VARS[:ends]        = true            # default
# Pagy::VARS[:page_param]  = :page           # default
# Pagy::VARS[:count_args]  = []              # example for non AR ORMs
# Pagy::VARS[:max_pages]   = 3000            # example
